...
const TrangCaNhanChiTiet = ({ lichSuMua }) => {
    ...
    const [thongTin, setThongTin] = useState({
        hoVaTen: user.user.data.hoVaTen,
        email: user.user.data.email,
        sdt: user.user.data.sdt,
        diaChi: user.user.data.diaChi,
    })
    ...
    const capNhatThongTin = async () => {
        const res = await axios.put(`${apiUrl}api/users/${user.user.data._id}`, {
    ...
    const capNhatAnhDaiDien = async (e) => {
        ...
        try {
            const res = await axios.put(`${apiUrl}api/users/${user.user.data._id}`, formData, {
                headers: {
                    token: `Bearer ${user.user.accessToken}`
                }
            })
        ...
        <div className="TrangCaNhanChiTiet">
            <div className="TrangCaNhanChiTiet__trai">
                ...
                <div className="TrangCaNhanChiTiet__trai__duoi">
                    ...
                    <div className="TrangCaNhanChiTiet__trai__duoi__item">
                        <h1>Họ và tên:</h1>
                        <input type="text" value={thongTin.hoVaTen} name="hoVaTen" onChange={doiThongTin} />
                    </div>
                    <div className="TrangCaNhanChiTiet__trai__duoi__item" >
                        <h1>Email:</h1>
                        <input type="text" value={thongTin.email} name="email" onChange={doiThongTin} />
                    </div>
                    <div className="TrangCaNhanChiTiet__trai__duoi__item">
                        <h1>Số điện thoại:</h1>
                        <input type="text" value={thongTin.sdt} name="sdt" onChange={doiThongTin} />
                    </div>
                    <div className="TrangCaNhanChiTiet__trai__duoi__item" >
                        <h1>Địa chỉ:</h1>
                        <input type="text" value={thongTin.diaChi} name="diaChi" onChange={doiThongTin} />
                    </div>
            ...
            <div className="TrangCaNhanChiTiet__phai">
                <div className="TrangCaNhanChiTiet__phai__danhsach">
                    ...
                    <div className="TrangCaNhanChiTiet__phai__danhsach__items">
                        {
                            lichSuMua ? (
                                lichSuMua.map((item, index) => {
                                    return (
                                        index < soLichSuShow ?
                                            <div className="TrangCaNhanChiTiet__phai__danhsach__item" key={index}>
                                                <Link to={`/chitiet/${item._id}`} className="TrangCaNhanChiTiet__phai__danhsach__item__link">
                                                    ...
                                                    <div className="TrangCaNhanChiTiet__phai__danhsach__item__thongtin__duoi">
                                                        ...
                                                        <div className="TrangCaNhanChiTiet__phai__danhsach__item__thongtin__duoi__phai">
                                                            <div className="TrangCaNhanChiTiet__phai__danhsach__item__thongtin__duoi__phai__nut">
                                                                ...
                                                                <p>Tổng số tiền: {doiSangPhanNghin(item.gia * item.soLuong)}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
